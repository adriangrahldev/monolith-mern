  ...
  return (
    <>
      <div className="h-screen space-y-4">
        ...
        >
          <Button variant={"ghost"} onClick={toggleCreateProjectModal}>
                  ...
                  <div className="grid grid-cols-1  md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                    {projects.length == 0 ? (
                      ...
                      projects.map((project) => (
                        <div key={project._id} className="hover:bg-gray-100">
                          <DefaultCard
                            title={project.name}
      ...
      <CreateProjectModal
        ...
        onSubmit={handleRegisterProjectSubmit}
