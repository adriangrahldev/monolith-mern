...
const Sidebar = ({routes}: {routes:any[]}) => {
    ...
    return (
        <div className="fixed w-20 flex flex-col items-center bg-slate-200 h-screen z-20">
            <div className="sidebar-brand border-b-2 h-20 flex items-center border-gray-300 w-full">
